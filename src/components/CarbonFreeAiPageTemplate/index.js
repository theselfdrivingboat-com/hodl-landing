                  ...
                  <div className="columns is-multiline">
                    ...
                    >
                      <p className="has-text-centered">
                        <ProgressiveImageContainer image="img/hodl-ai-1.png" />
                        <OutboundLink href="/about">
                          <ProgressiveImageContainer image="img/hodl-ai-link-1.png" />
                        </OutboundLink>
                        <ProgressiveImageContainer image="img/hodl-ai-2.png" />
                        <a href="http://www.clickclean.org/usa/en/">
                          <ProgressiveImageContainer image="img/hodl-ai-link-2.png" />
                        </a>
                        <ProgressiveImageContainer image="img/hodl-ai-3.png" />
                        <a href="https://cloud.google.com/sustainability">
                          <ProgressiveImageContainer image="img/hodl-ai-link-3.png" />
                        </a>
                        <ProgressiveImageContainer image="img/hodl-ai-4.png" />
                        <a href="https://arxiv.org/abs/1906.02243">
                          <ProgressiveImageContainer image="img/hodl-ai-link-4.png" />
                        </a>
                        <ProgressiveImageContainer image="img/hodl-ai-6.png" />
                        <a href="https://openai.com/blog/ai-and-compute/">
                          <ProgressiveImageContainer image="img/hodl-ai-link-6.png" />
                        </a>
                        <ProgressiveImageContainer image="img/hodl-ai-7.png" />
                      </p>
                      <a href="https://docs.google.com/forms/d/e/1FAIpQLSf5a5-tKhH25EkxLizDFlX9m_bprySjY0uEE7lG4lnOfx_DtA/viewform?usp=sf_link">
                        <ProgressiveImageContainer image="img/hodl-link-beta.png" />
                      </a>
                      <ProgressiveImageContainer image="img/hodl4.png" />
                      <iframe
                        style={{ width: "100%", height: "70vh" }}
                        src="https://www.youtube.com/embed/gl36tKSPEgM"
                        title="YouTube video player"
                        frameBorder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
                      <ProgressiveImageContainer image="img/hodl-7.png" />
                      <div className="columns">
                        <a href="https://www.lessand.ro">
                          <div className="column">
                            <ProgressiveImageContainer image="img/hodl-alex.png" />
                          </div>
                        </a>
                        <a href="https://twitter.com/0xflores">
                          <div className="column">
                            <ProgressiveImageContainer image="img/hodl-oana.png" />
                          </div>
                        </a>
                        <a href="https://twitter.com/sid_hypeman">
                          <div className="column">
                            <ProgressiveImageContainer image="img/hodl-siddarth.png" />
                          </div>
                        </a>
                        <a href="https://www.linkedin.com/in/arwa-arif/">
                          <div className="column">
                            <ProgressiveImageContainer image="img/hodl-arwa.png" />
                          </div>
                        </a>
                      </div>
                    </div>
